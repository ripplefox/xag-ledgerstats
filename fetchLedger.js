...
let endpoint = 'wss://g1.xrpgen.com'
...
ws.on('message', function incoming (data) {
  ...
  if (ledger === null) {
    if (typeof r.error_message === 'undefined') {
      ...
      console.log('Now fetching XAG ledger', ledger.ledger_index)
      console.log('')
      console.log(' -- Ledger close time:  ', ledger.close_time_human)
      console.log(' -- Ledger hash:        ', ledger.hash)
      console.log(' -- Total XAG existing: ', numeral(parseInt(ledger.total_coins) / 1000000).format('0,0.000000'))
      console.log('')
